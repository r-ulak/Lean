...
{
    public class ReverseEtfMomentumWithStopTrailingLoss : QCAlgorithm
    {
        ...
        private decimal stopLossPercent = 0.90m;
        ...
        public override void OnData(Slice data)
        {
            ...
            if (sortedStockDatas.Count > 0)
            {
                ...
                if (selectedStockData.Ticker != stockHeld)
                {
                    ...
                    highestPrice[Securities[selectedStockData.Ticker].Symbol.Value] =
                        Securities[selectedStockData.Ticker].Close;
                }
            }
