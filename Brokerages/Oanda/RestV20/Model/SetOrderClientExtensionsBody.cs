...
namespace Oanda.RestV20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SetOrderClientExtensionsBody :  IEquatable<SetOrderClientExtensionsBody>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SetOrderClientExtensionsBody);
        }

        /// <summary>
        /// Returns true if SetOrderClientExtensionsBody instances are equal
        /// </summary>
        /// <param name="other">Instance of SetOrderClientExtensionsBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetOrderClientExtensionsBody other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
