...
namespace Oanda.RestV20.Model
{
    ...
    public partial class ClientConfigureRejectTransaction :  IEquatable<ClientConfigureRejectTransaction>, IValidatableObject
    {
        ...
        /// <param name="Type">The Type of the Transaction. Always set to \&quot;CLIENT_CONFIGURE_REJECT\&quot; in a ClientConfigureRejectTransaction..</param>
        ...
        public ClientConfigureRejectTransaction(string Id = default(string), string Time = default(string), int? UserID = default(int?), string AccountID = default(string), string BatchID = default(string), string RequestID = default(string), TypeEnum? Type = default(TypeEnum?), string Alias = default(string), string MarginRate = default(string), RejectReasonEnum? RejectReason = default(RejectReasonEnum?))
        {
            this.Id = Id;
            this.Time = Time;
            this.UserID = UserID;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ClientConfigureRejectTransaction);
        }

        /// <summary>
        /// Returns true if ClientConfigureRejectTransaction instances are equal
        /// </summary>
        /// <param name="other">Instance of ClientConfigureRejectTransaction to be compared</param>
        /// <returns>Boolean</returns>
