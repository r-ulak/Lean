...
namespace Oanda.RestV20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TradeClientExtensionsModifyRejectTransaction :  IEquatable<TradeClientExtensionsModifyRejectTransaction>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="Type">The Type of the Transaction. Always set to \&quot;TRADE_CLIENT_EXTENSIONS_MODIFY_REJECT\&quot; for a TradeClientExtensionsModifyRejectTransaction..</param>
        ...
        public TradeClientExtensionsModifyRejectTransaction(string Id = default(string), string Time = default(string), int? UserID = default(int?), string AccountID = default(string), string BatchID = default(string), string RequestID = default(string), TypeEnum? Type = default(TypeEnum?), string TradeID = default(string), string ClientTradeID = default(string), ClientExtensions TradeClientExtensionsModify = default(ClientExtensions), RejectReasonEnum? RejectReason = default(RejectReasonEnum?))
        {
            this.Id = Id;
            this.Time = Time;
            this.UserID = UserID;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TradeClientExtensionsModifyRejectTransaction);
        }

        /// <summary>
        /// Returns true if TradeClientExtensionsModifyRejectTransaction instances are equal
        /// </summary>
        /// <param name="other">Instance of TradeClientExtensionsModifyRejectTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TradeClientExtensionsModifyRejectTransaction other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
