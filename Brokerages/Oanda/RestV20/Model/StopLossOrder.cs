...
namespace Oanda.RestV20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StopLossOrder :  IEquatable<StopLossOrder>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as StopLossOrder);
        }

        /// <summary>
        /// Returns true if StopLossOrder instances are equal
        /// </summary>
        /// <param name="other">Instance of StopLossOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StopLossOrder other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
