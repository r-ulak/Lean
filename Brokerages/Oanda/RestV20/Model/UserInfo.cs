...
namespace Oanda.RestV20.Model
{
    ...
    public partial class UserInfo :  IEquatable<UserInfo>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Username">The user-provided username..</param>
        ...
        public UserInfo(string Username = default(string), int? UserID = default(int?), string Country = default(string), string EmailAddress = default(string))
        {
