...
namespace Oanda.RestV20.Model
{
    ...
    public partial class InlineResponse4041 :  IEquatable<InlineResponse4041>, IValidatableObject
    {
        ...
        public InlineResponse4041(Transaction OrderCancelRejectTransaction = default(Transaction), List<string> RelatedTransactionIDs = default(List<string>), string LastTransactionID = default(string), string ErrorCode = default(string), string ErrorMessage = default(string))
        {
