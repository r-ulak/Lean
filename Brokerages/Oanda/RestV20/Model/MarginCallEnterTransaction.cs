...
namespace Oanda.RestV20.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MarginCallEnterTransaction :  IEquatable<MarginCallEnterTransaction>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="Type">The Type of the Transaction. Always set to \&quot;MARGIN_CALL_ENTER\&quot; for an MarginCallEnterTransaction..</param>
        public MarginCallEnterTransaction(string Id = default(string), string Time = default(string), int? UserID = default(int?), string AccountID = default(string), string BatchID = default(string), string RequestID = default(string), TypeEnum? Type = default(TypeEnum?))
        {
            this.Id = Id;
            this.Time = Time;
            this.UserID = UserID;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MarginCallEnterTransaction);
        }

        /// <summary>
        /// Returns true if MarginCallEnterTransaction instances are equal
        /// </summary>
        /// <param name="other">Instance of MarginCallEnterTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarginCallEnterTransaction other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
